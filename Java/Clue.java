...
public class Clue {
  ...
  public String rooms[] = {"Kitchen", "Ball Room", "Conseratory", "Billard Room", "Library", "Study", "Hall", "Lounge", "Dining Room"};
...
/** 	
  public void assignSolution() {
	  ...
	  Character character = new Character(characters[randomChar], false, null, null, null);
